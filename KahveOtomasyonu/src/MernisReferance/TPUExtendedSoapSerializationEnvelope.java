...
public class TPUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TPUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TPUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TPUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TPUDateTimeConverter dateTimeConverter = new TPUStandardDateTimeConverter();

    public TPUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TPUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TPUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TPUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TPUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TPUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
