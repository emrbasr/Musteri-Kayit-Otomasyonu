...
public class TPUKPSPublicSoap
{
    ...
    public TPUKPSPublicSoap(){}

    public TPUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TPUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TPUExtendedSoapSerializationEnvelope envelope= new TPUExtendedSoapSerializationEnvelope(TPUExtendedSoapSerializationEnvelope.VER11);
